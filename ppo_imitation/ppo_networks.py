...
def make_inference_fn(ppo_networks: PPOImitationNetworks):
    ...
    def make_policy(
        ...
        def policy(
            ...
            random_actions = jax.random.uniform(key_sample, shape=(action_size,), minval=-1, maxval=1)
            rand_log_prob = parametric_action_distribution.log_prob(logits, random_actions)
